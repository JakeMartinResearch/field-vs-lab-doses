...
Let's check if there is a correlation between detections and percentage of positive detections in the environmental databases and number of tests in the EIPAAB databases. <br>
...
**Table 1:** the 10 most common compounds in EIPAAB versus occurrence and detection frequency in UBA surface waters
UBA samples
...
##### Table 2
<br>
**Table 2:** Compounds with the most environmental detections that are not present in EIPAAB.
...
**Table 3:** The compounds with the highest detection rate not found in the EIPAAB database
...
**Table 4:** The number of exposures in the EIPAAB database that used concentrations less then median and upper 95% credible interval of surface water and effluent concentrations
